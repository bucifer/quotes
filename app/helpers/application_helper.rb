...
image_tag('brucelee.jpg', :alt => author.to_s, :size => '200x130', :title => author.to_s)
			when "Buddha"
image_tag('buddha.jpg', :alt => author.to_s, :size => '100x100', :title => author.to_s)
			when "Apple"
			...
			when "Mahatma Gandhi"
				image_tag('gandhi.jpg', :alt => author.to_s, :size => '130x130', :title => author.to_s)
			when "John F. Kennedy"
				image_tag('jfk.jpg', :alt => author.to_s, :size => '150x130', :title => author.to_s)
			when "Albert Einstein"
				image_tag('einstein.jpg', :alt => author.to_s, :size => '150x110', :title => author.to_s)
			end
	end
